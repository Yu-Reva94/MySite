            ...
            <form action="editUsers.php" method="post">
                ...
                <div class="col">
                    <div class="mb-3 ">
                        ...
                        <input type="text" name="login" value="<?php echo $user['username']; ?>" class="form-control"
                               id="exampleFormControlLogin" placeholder="Логин">
                    </div>
                    <div class="mb-3">
                        <label for="exampleFormControlEmail" class="form-label">Эл. почта</label>
                        <input type="email" readonly name="mail" value="<?php echo $user['email']; ?>" class="form-control"
